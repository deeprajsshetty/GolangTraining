...
func main() {
	fmt.Println("******Example display the result of Pass by Value and Shared Data***************************************************")
	u1 := createUserV1()
	u2 := createUserV2()
...
// createUserV2 creates a user value and share
...
/* Output
******Example display the result of Pass by Value and Shared Data***************************************************
V1 &{deep deep@gmail.com}
V2 &{deep deep@gmail.com}
u1 &{deep deep@gmail.com} u2 &{deep deep@gmail.com}
*/
